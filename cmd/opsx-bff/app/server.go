...
// NewOpsxBffCommand 创建一个 *cobra.Command 对象，用于启动应用程序.
func NewOpsxBffCommand() *cobra.Command {
	cmd := &cobra.Command{
		// 指定命令的名字，该名字会出现在帮助信息中
		Use: "opsx-bff",
		// 命令的简短描述
		Short: "Opsx Backend for Frontend",
		// 命令的详细描述
		Long: `Opsx Backend for Frontend.
